...
This file is the working agreement for anyone (human or Codex) editing this codebase.
...
| # | Scope | State |
|---|---|---|
| 1 | Scaffold + tokens + photos + AGENTS.md + scripts | this commit |
...
Each commit pushes to `origin/Codex/airbnb-rental-template-XewnD`. No PR opened unless explicitly requested.
